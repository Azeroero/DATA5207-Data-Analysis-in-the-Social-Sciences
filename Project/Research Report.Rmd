...
#remove "(A)", "(C)" in Census_Name_2016 and save into lga_name
...
temp <- melt(all_data, measure.vars=c("male.victim.percentage", "female.victim.percentage"))
head(temp$variable)

#TODO: Add aesthetic features ----------------------
ggplot(temp, aes(x=value, color=variable)) + 
  geom_density() +
